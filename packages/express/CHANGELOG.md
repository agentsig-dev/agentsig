...
- 000b6a8: Prepare the coordinated 0.2.0 release of the core and four integration packages.
  ...
  The maintainer accepted M4 after all 11 adapter smoke scenarios passed and
  confirmed green CI for core-m4. Version 0.2.0 is prepared locally but not
  published. This is not production-readiness or independent security-audit
  evidence. The Structured Fields package and dependency remain at 0.1.1.

### Patch Changes

- Updated dependencies [000b6a8]
  - @agentsig/core@0.2.0
